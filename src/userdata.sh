...
[Service]
ExecStart=/usr/local/bin/ttyd -p 7681 -i 127.0.0.1 -W -t fontSize=14 -t fontFamily="'Fira Code', 'JetBrains Mono', 'Cascadia Code', monospace" -t fontCSS="@import url('https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;500&family=JetBrains+Mono:wght@400;500&display=swap');" -t rendererType=canvas -t charset="UTF-8" bash -c "export LANG=en_US.UTF-8 LC_ALL=en_US.UTF-8; su - ubuntu"
Type=simple
Restart=always
User=root
Group=root
